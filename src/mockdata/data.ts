...
export const products: Product[] = [
    {
        ...
        category: 'Cloths', subCategory: '', description: 'MR.SIGA Microfiber Cleaning Cloth, All-Purpose Cleaning Towels.',
        name: 'Cleaning Cloth', brand: 'Nike', color: 'Yellow', price: 100
    },
    {
        ...
        name: 'Electronics Fan', brand: 'Dreo', color: 'Black', price: 1000
    },
    {
        ...
        name: 'Baby shirt and pants', brand: 'Zara', color: 'Black', price: 250
    },
    {
        id: 4, image: require('../assets/images/Winter_Cloths_item4.jpg'),
        category: 'Cloths', subCategory: 'Winter', description: 'Baby Long Sleeve Gentleman White Shirt Jumpsuit Overall Romper.',
        name: 'Newborn Baby suits', brand: 'H&M', color: 'Black', price: 999
    },
    {
        ...
        name: 'Painting', brand: 'Gionlion', color: 'Purple', price: 499
    },
    {
        ...
        name: 'Painting Brush', brand: 'Gionlion', color: 'Pink', price: 349
    },
    {
        ...
        name: 'Art Paper', brand: 'Gionlion', color: 'Yellow', price: 342
    },
    {
        ...
        name: 'Plazo', brand: 'Zara', color: 'Pink', price: 189
    },
    {
        ...
        name: 'Palazzo', brand: 'Zara', color: 'Purple', price: 300
    },
    {
        ...
        name: 'Men Suits', brand: 'Zara', color: 'Blue', price: 4000
    },
    {
        ...
        name: 'Casual Hooded', brand: 'Zara', color: 'White', price: 880
    },
    {
        ...
        name: 'Warm Sweater', brand: 'Zara', color: 'White', price: 500
    },
    {
        id: 13, image: require('../assets/images/Baby_Cloths_item3.jpg'),
        category: 'Cloths', subCategory: 'Men', description: 'Winter Warm Knitted Sweater Men Casual Cotton Hooded.',
        name: 'Cloths Warm Sweater', brand: 'H&M', color: 'Black', price: 5000
    },
    {
        id: 14, image: require('../assets/images/Women_Cloths_item8.jpg'),
        category: 'Cloths', subCategory: 'Men', description: 'Winter Warm Knitted Sweater Men Casual Cotton Hooded.',
        name: 'Cloths Warm Sweater', brand: 'H&M', color: 'Purpal', price: 1500
    },
    {
        id: 15, image: require('../assets/images/Women_Cloths_item9.jpg'),
        category: 'Cloths', subCategory: 'Men', description: 'Winter Warm Knitted Sweater Men Casual Cotton Hooded.',
        name: 'Cloths Warm Sweater', brand: 'H&M', color: 'Pink', price: 2500
    },
];
